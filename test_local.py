"""
Script para testear el agente de manera local
"""
...
os.environ["LANGCHAIN_PROJECT"] = "agente_123"
    ...
    [
        ("system",
            ...
            2.  **Seleccionar la Herramienta Adecuada:** Basado en la intención, elige la herramienta correcta:
                ...
                *   Si el usuario pide consejos de ahorro tu herramienta es `consejos_de_ahorro`.
                *   Si el usuario realizar preguntas sobre ahorro e inversiones tu herramienta es `preguntas_frecuentes`.
...
def main(id_agente, msg):
    """
    Función principal para ejecutar y testear el agente
    """
...
while True:
    ...
    # Criterio para terminar el bucle
    if msg == '':
        break
    
    print(f'Usuario: {msg}')
    # Ejecutamos el agente
    response = main(id_agente, msg)
